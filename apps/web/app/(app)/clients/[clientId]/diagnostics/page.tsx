...
import { Activity, CheckCircle, AlertCircle, AlertTriangle, Info, RefreshCw } from 'lucide-react'
    ...
    <div className="p-6 max-w-3xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold text-white">Diagnóstico do Pixel</h1>
